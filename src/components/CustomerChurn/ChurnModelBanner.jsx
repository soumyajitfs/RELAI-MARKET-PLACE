      ...
      <div className="banner-content">
        <div className="banner-left">
          ...
          <p className="banner-description">
            Predicts subscribers likely to churn so teams can intervene before cancellation.
          </p>
        ...
        <div className="banner-right">
          <div className="accuracy-card">
            ...
            <span className="accuracy-value">84%</span>
          </div>
        </div>
      </div>
    </div>
...
export default ChurnModelBanner;
